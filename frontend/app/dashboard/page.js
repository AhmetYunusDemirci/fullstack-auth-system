    ...
    <main className="container-center bg-gray-100">
      <div className="card w-[450px]">
        ...
        <div className="flex justify-center mb-4">
          <div className="w-24 h-24 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 text-white flex items-center justify-center text-4xl font-bold">
        ...
        <h2 className="text-xl text-center text-blue-600 mt-2">{user.name} {user.surname}</h2>
